...
namespace Potato
{
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(POTATO_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(POTATO_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
